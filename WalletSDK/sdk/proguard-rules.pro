...
-keep public class com.example.sdk.SDK { *; }
-keep public interface com.example.sdk.SDKCallBack { *; }
...
#
#webView需要进行特殊处理
-keepclassmembers class wendu.dsbridge.DWebView {
   public *;
}
-keepclassmembers class * extends com.tencent.smtt.sdk.WebViewClient {
    public void *(com.tencent.smtt.sdk.WebVieww, java.lang.String, android.graphics.Bitmap);
...
-keepclassmembers class com.example.sdk.dsbridge.JsApi {
    <methods>;
}
...
#-keep class com.example.sdk.utils.**{*;}
#-keep interface com.orhanobut.logger.**{*;}
