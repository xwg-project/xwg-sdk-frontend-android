...
//        LogUtils.e("初始化开始时间"+new Date());
        SDK.getInstance().init(this,new SDKCallBack() {
...
//                LogUtils.e("onInit 执行了--"+code+ ":"+errmsg);
            ...
            @Override
            public void onLoginUserName(int i, String s) {
                //此处游戏需要自己处理， 使用appid和用户名 去获取授权码
                Log.e("1", "onLoginUserName: " );
                SDK.getInstance().loginAuth(MainActivity.this,getAuthCode("1561527878813","e31ac1bb84934aaa9e46d5daf08301d9",s));
            }
        });
        initView();
        initClickListener();
